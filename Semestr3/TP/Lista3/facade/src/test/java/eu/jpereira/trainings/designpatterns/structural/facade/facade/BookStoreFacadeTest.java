...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	protected BookstoreFacade createFacade() {
		...
		DefaultBookstoreFacade bookstoreFacade= new DefaultBookstoreFacade(customerService, bookService, customerNotificationService, orderingService, warehouseService );
